    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_no', models.CharField(blank=True, help_text='contact no. should be maximum of 15 characters', max_length=15)),
                ...
                ('link', models.CharField(help_text=' name can be max. of 50 characters', max_length=50)),
