...
class FilterForContact(django_filters.FilterSet):
    ...
    class Meta:
        model = Contact
        fields = [ 'active', 'id', 'name', 'contact_no','email','address']
...
class ContactViewSet(viewsets.ModelViewSet):
    ...
    filter_class = FilterForContact
    search_fields = ['name',  'id','contact_no']
