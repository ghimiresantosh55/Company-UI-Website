...
from .serializers import OurTeamSerializer, CeoMessageSerializer
from rest_framework import permissions


class FilterForOurTeam(django_filters.FilterSet):
    ...
    class Meta:
        model = OurTeam
        fields = [ 'active', 'id', 'name','position']
...
class OurTeamViewSet(viewsets.ModelViewSet):
    ...
    filter_class = FilterForOurTeam
    search_fields = ['name', 'position', 'id']
...
class FilterForCeoMessage(django_filters.FilterSet):
    # for date range filter after_date and before_date
    date = django_filters.DateFromToRangeFilter(field_name="created_date_ad")
...
class CeoMessageViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [SearchFilter, OrderingFilter, DjangoFilterBackend]
    filter_class = FilterForCeoMessage
