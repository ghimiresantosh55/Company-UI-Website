# Generated by Django 3.2 on 2023-01-11 09:49

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import src.about.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='blog', validators=[src.about.models.validate_image])),
                ('position', models.TextField(blank=True, help_text='descriptions should be maximum of 200 characters and can be blank', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text=' name can be max. of 50 characters', max_length=50, unique=True)),
                ('image', models.ImageField(blank=True, upload_to='blog', validators=[src.about.models.validate_image])),
                ('description', models.TextField(blank=True, help_text='descriptions should be maximum of 200 characters and can be blank', max_length=200)),
                ('active', models.BooleanField(default=True, help_text='By default active=True')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
