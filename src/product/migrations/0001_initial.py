    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_name', models.CharField(help_text=' name can be max. of 50 characters', max_length=50, unique=True)),
                ('name', models.CharField(help_text=' name can be max. of 50 characters', max_length=50, unique=True)),
                ('image', models.ImageField(blank=True, upload_to='blog', validators=[src.product.models.validate_image])),
